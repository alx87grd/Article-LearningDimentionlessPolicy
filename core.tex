...
\end{align}
%%%%%%%%%%%%%%%%%%%%%%
confirming equation eq. \eqref{eq:ct_dim_rel}.

Also, we will use this exemple analytical solution to show that, when the dimentionless context is equal, scaling a policy using eq. \eqref{eq:ab_transform}, is equivalent to pluging new values of the system parameters. Lets assume we have two context $a$ and $b$, leading to two version of the computed torque feedback law:
%%%%%%%%%%%%%%%%%%%%%%
\begin{align}
