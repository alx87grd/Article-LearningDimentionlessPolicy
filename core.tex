...
\end{abstract}
%The dimensional analysis also show that multiple systems of various dimensions can share a data-base for reinforcement learning. %TODO: (We also demonstrate that by leveraging this scheme when using reinforcement learning, multiple systems of various dimentions can share a data-base during the learning phase, which can be a big advantage for data efficiency.) 
...
%%%%%%%%%%%%%%%%%%%%%%
\section{Optimal longitudinal car parking task}
