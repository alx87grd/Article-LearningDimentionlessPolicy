...
\begin{table}[htb]
   ...
   %%%%%%%%%%%%%%%%%%%%%
   \hline \hline \noalign{\smallskip} 
   \multicolumn{6}{c}{\textbf{Problems with $\tau_{max}^* = 0.2$ and $q^* = 0.05$} }\\ \noalign{\smallskip}  \hline\hline  \noalign{\smallskip} 
   %%%%%%%%%%%%%%%%%%%%%%
   Context no 4 : & 1.0 & 10.0 & 1.0 & 0.5 & 2.0 \\
   Context no 5 : & 1.0 & 10.0 & 2.0 & 1.0 & 4.0 \\
   Context no 6 : & 2.0 & 10.0 & 1.0 & 1.0 & 4.0 \\
   %%%%%%%%%%%%%%%%%%%%%
   \hline \hline \noalign{\smallskip} 
...
\begin{figure}[p]
\begin{center}
\includegraphics[width=0.99\linewidth]{fig/p1_policy.png}
\caption{Pendulum no1 optimal policy}\label{fig:p1_policy}
\end{center}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[p]
\begin{center}
\includegraphics[width=0.99\linewidth]{fig/p2_policy.png}
\caption{Pendulum no2 optimal policy}\label{fig:p2_policy}
\end{center}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[p]
\begin{center}
\includegraphics[width=0.99\linewidth]{fig/p3_policy.png}
\caption{Pendulum no3 optimal policy}\label{fig:p3_policy}
\end{center}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[p]
\begin{center}
\includegraphics[width=0.99\linewidth]{fig/p1_traj.png}
\caption{Pendulum no1 optimal traj}\label{fig:p1_traj}
\end{center}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[p]
\begin{center}
\includegraphics[width=0.99\linewidth]{fig/p2_traj.png}
\caption{Pendulum no2 optimal traj}\label{fig:p2_traj}
\end{center}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[p]
\begin{center}
\includegraphics[width=0.99\linewidth]{fig/p3_traj.png}
\caption{Pendulum no3 optimal traj}\label{fig:p3_traj}
\end{center}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%
